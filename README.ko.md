...
| | llm-frames | vcsi | ffmpeg (직접) | video2dataset |
|---|---|---|---|---|
| **목적** | LLM 컨텍스트 주입 | 사람용 컨택트 시트 | 프레임 추출 | 데이터셋 파이프라인 |
| **출력** | 그리드 JPEG + XML 타임스탬프 | 컨택트 시트 이미지 | 개별 프레임 파일 | 프레임 / 클립 |
...
| **런타임** | Node.js + ffmpeg | Python | ffmpeg | Python + 무거운 의존성 |
